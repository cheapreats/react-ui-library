...
export const StoreSelector: React.FC<StoreSelectorProps> = ({
    ...
    const currentCardObject = storeProfileData.find(storeProfileData => storeProfileData.storeSelectorId === currentIndex);
    /**
        ...
        <StoreSelectorBox {...props}>
            ...
            <ArrowsDiv downArrowEnabled={downArrowEnabled} upArrowEnabled={upArrowEnabled}
                ...
                <UpArrowDiv upArrowEnabled={upArrowEnabled} storeProfileData={storeProfileData} onClick={onClickUp}>
                    <SelectorArrowUp onClick={() => indexIncrease(currentIndex, setCurrentIndex, storeProfileData)} />
                </UpArrowDiv>
                <DownArrowDiv downArrowEnabled={downArrowEnabled} storeProfileData={storeProfileData} onClick={onClickDown}>
                    <SelectorArrowDown onClick={() => indexDecrease(currentIndex, setCurrentIndex, storeProfileData)} />
                </DownArrowDiv>
            </ArrowsDiv>
        </StoreSelectorBox>
    )
...
const UpArrowDiv = styled.div<StoreSelectorProps>`
    pointer-events: ${StoreSelector => StoreSelector.upArrowEnabled ? `auto` : `none` };
`
...
const DownArrowDiv = styled.div<StoreSelectorProps>`
     pointer-events: ${StoreSelector => StoreSelector.downArrowEnabled ? `auto` : `none` }; 
`
