...
export default {
    ...
    args: {
        ...
        footerItems,
        middleItems: <SmallText color='white' margin="10px auto">Get Updates from the store</SmallText>,
        qrRightContent:<SmallText color='black' margin="10px auto">Get Updates from the store</SmallText>
    },
} as Meta;
