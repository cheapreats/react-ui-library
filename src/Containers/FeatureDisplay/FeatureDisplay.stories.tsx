...
const defaultArgs = {
    ...
    featureSubTitle: 'Stripe Radar uses sophisticated machine learning trained daily on data from millions of global businesses to protect you from fraudsters.',
    featureImage:
