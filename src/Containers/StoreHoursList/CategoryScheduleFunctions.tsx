 ...
 */
export const createCategoryWithHours = (categoryName: string): ICategoryWithHoursTypes => {
 ...
 * @returns {ICategoryWithHoursTypes} 
 */
export const findActive = (categorySchedules: ICategoryWithHoursTypes[]): ICategoryWithHoursTypes => {
