...
const defaultArgs = {
    ...
    logoA: {
        url:
            'https://passiveincomemd.com/wp-content/uploads/2018/12/cozy-logo-orange-1024x341.png',
        width: '80px',
        title: 'cozy logo',
    },
    logoB: {
    ...
    logoC: {
        url:
            'https://lever-client-logos.s3.amazonaws.com/1896f2f7-640c-44b0-bd47-47d25ac5c003-1580424543682.png',
        width: '55px',
        title: 'lyra logo',
    },
    logoD: {
    ...
    logoE: {
        url:
            'https://wpengine.com/wp-content/uploads/2020/01/bluestate_logo_2-color_rgb1.png',
        width: '200px',
